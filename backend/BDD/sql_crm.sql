...
CREATE TABLE IF NOT EXISTS `bd_crm`.`infrastructure_edu` (
  `Id_Infra_Str` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bd_crm`.`besoins_etab_sco` (
  `Id_Bes` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bd_crm`.`membre_equipe` (
  `Id_Mem_Eq` INT NOT NULL AUTO_INCREMENT,
  ...
  `login_membre` VARCHAR(50) NULL DEFAULT NULL,
  `password_membre` VARCHAR(50) NULL DEFAULT NULL,
  `role_membre` VARCHAR(50) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bd_crm`.`suivi` (
  `Id_Suiv` INT NOT NULL AUTO_INCREMENT,
